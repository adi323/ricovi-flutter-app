...
import 'package:ricovi/pages/homepage/settings/changepassword.dart';
      ...
      builder: (cnt)=>Scaffold(
        ...
        body:ListView(
          ...
          children: [
            ...
            const CircleAvatar(radius: 80,backgroundImage: NetworkImage('https://images.pexels.com/photos/2395251/pexels-photo-2395251.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'),),
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).push(CustomRoute(child: ChangePassword(),time:Duration(milliseconds: 1200)));
              },
              child: Row(
                children: [
