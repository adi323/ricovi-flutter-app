      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Set a name for your AI Frame',textAlign: TextAlign.start,style: TextStyle(color: Colors.black,fontSize: 24,fontWeight: FontWeight.w600),),
            const SizedBox(height: 20,),
            const Text('Name For AI Frame',style: TextStyle(color: Colors.black45,fontSize: 16,fontWeight: FontWeight.w500),),
